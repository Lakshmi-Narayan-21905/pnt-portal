...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ title, navItems, userRoleLabel, theme = 'indigo' }) => {
    ...
    useEffect(() => {
        ...
        const checkUnread = async () => {
            ...
            try {
                ...
                const data: number = await AnnouncementService.getLatestAnnouncementDate(userProfile.department);
        ...
        return () => {
            isMounted = false;
            window.removeEventListener('announcementsRead', handleReadEvents);
        };
    ...
    const themeConfig = {
        purple: {
            sidebarGradient: 'bg-white border-r border-gray-200 shadow-sm',
            ...
            logoBg: 'bg-brand-purple-primary',
        ...
        blue: {
            sidebarGradient: 'bg-white border-r border-gray-200 shadow-sm',
            activeItemBg: 'bg-brand-ice text-brand-blue border-r-[3px] border-brand-primary rounded-none',
            activeItemText: 'text-brand-blue font-bold',
            accentText: 'text-gray-500',
            logoBg: 'bg-brand-blue',
            hoverBg: 'hover:bg-gray-50 hover:text-gray-900',
            lightAccent: 'bg-gray-100 text-gray-600 hover:bg-gray-200',
            border: 'border-gray-200',
        },
        green: {
            sidebarGradient: 'bg-white border-r border-gray-200 shadow-sm',
            activeItemBg: 'bg-brand-green-ice text-brand-green-deep border-r-[3px] border-brand-green-primary rounded-none',
            activeItemText: 'text-brand-green-deep font-bold',
            accentText: 'text-gray-500',
            logoBg: 'bg-brand-green-primary',
            hoverBg: 'hover:bg-gray-50 hover:text-gray-900',
            lightAccent: 'bg-gray-100 text-gray-600 hover:bg-gray-200',
            border: 'border-gray-200',
        },
        lavender: {
            ...
            accentText: 'text-gray-500',
            logoBg: 'bg-brand-lavender-primary',
            hoverBg: 'hover:bg-gray-50 hover:text-gray-900',
            lightAccent: 'bg-gray-100 text-gray-600 hover:bg-gray-200',
            border: 'border-gray-200',
        },
