    ...
    return (
        <div className="flex h-screen font-sans overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-transparent h-screen overflow-hidden">
                ...
                <header className="h-14 md:h-0 bg-transparent border-none flex items-center justify-between px-6 md:hidden sticky top-0 z-30 shadow-none">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:px-6 md:py-4 relative scroll-smooth">
                    <Outlet />
                </main>
            </div>
        </div >
