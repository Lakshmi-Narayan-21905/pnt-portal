...
import { LayoutDashboard, User, LogOut, Menu, X, Briefcase, GraduationCap } from 'lucide-react';
...
const StudentLayout: React.FC = () => {
    ...
    const navItems = [
        ...
        { icon: Briefcase, label: 'Applied Drives', path: '/student/drives' }, // Placeholder for now
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="w-64 bg-white shadow-lg z-10 hidden md:flex flex-col">
                <div className="p-6 border-b border-gray-200 flex items-center">
                    ...
                    <div>
                        <span className="text-lg font-bold text-gray-800 block leading-tight">Student Portal</span>
                    </div>
                </div>
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                    {navItems.map((item) => (
                        ...
                        >
                            <item.icon className={`h-5 w-5 mr-3 ${isActive(item.path) ? 'text-indigo-600' : 'text-gray-400'}`} />
                            {item.label}
                        </Link>
                    ))}
                </nav>
