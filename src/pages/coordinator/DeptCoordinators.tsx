                ...
                <table className="min-w-full divide-y divide-brand-lavender-light/30">
                    <thead className="bg-brand-lavender-ice/50">
                        <tr>
                            ...
                            <th className="px-6 py-4 text-left text-xs font-semibold text-brand-lavender-deep uppercase tracking-wider">Department</th>
                        </tr>
                    </thead>
                        ...
                        {loading ? (
                            ...
                            coordinators.map((coord) => (
                                <tr key={coord.uid} className="hover:bg-brand-lavender-ice/30 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{coord.email}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 font-medium">
                                        <span className="px-2 py-0.5 rounded bg-gray-100 border border-gray-200 text-xs">
                                            {coord.department} {coord.section ? `(${coord.section})` : ''}
                                        </span>
                                    </td>
                                </tr>
                            ))
